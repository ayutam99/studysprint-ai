  ...
  return (
    <PageShell>
      <div className="space-y-6">
        ...
        <button
          className="perspective-[1000px] mx-auto block w-full max-w-2xl cursor-pointer text-left"
        ...
        >
          <motion.div
            ...
            className="glass relative min-h-64 rounded-3xl p-8 text-center [transform-style:preserve-3d]"
          >
            <div className="[backface-visibility:hidden]">
              <p className="mb-2 text-sm text-slate-400">Front</p>
              <h2 className="text-2xl font-bold">{current.front}</h2>
            </div>
            <div className="absolute inset-0 flex items-center justify-center p-8 [backface-visibility:hidden] [transform:rotateY(180deg)]">
              <div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            ...
            className="rounded-xl bg-rose-500/20 px-4 py-2 text-rose-300"
          >
            Mark Unknown
          </button>
        </div>
