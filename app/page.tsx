    ...
    <PageShell>
      <section className="grid items-center gap-8 py-12 md:grid-cols-2">
        <div className="space-y-5">
          <p className="w-fit rounded-full border border-neonBlue/40 bg-neonBlue/10 px-3 py-1 text-sm text-neonBlue">AI Study Copilot for Last-Minute Prep</p>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href="/dashboard" className="rounded-xl bg-gradient-to-r from-neonBlue to-neonPurple px-5 py-3 font-semibold">
              Start Free
            </Link>
            <Link href="/prep" className="rounded-xl border border-white/20 px-5 py-3 font-semibold hover:bg-white/10">
              Emergency Prep
            </Link>
          </div>
        </div>
